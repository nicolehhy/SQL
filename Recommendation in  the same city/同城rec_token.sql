...
count(distinct concat(udfsmid(smid), '_', live_id)) as view_pv,
case when token rlike 'rec_4_1_1_0' then '4_1_1_0'
when token rlike 'rec_4_1_1_1' then '4_1_1_1'
when token rlike 'rec_4_1_1_3' then '4_1_1_3'
when token rlike 'rec_4_1_1_4' then '4_1_1_4'
...
count(distinct concat(udfsmid(smid), '_', live_id)) as effview_pv,
case when token rlike 'rec_4_1_1_0' then '4_1_1_0'
when token rlike 'rec_4_1_1_1' then '4_1_1_1'
when token rlike 'rec_4_1_1_3' then '4_1_1_3'
when token rlike 'rec_4_1_1_4' then '4_1_1_4'
...
;">tongcheng_rec_token_d.txt          
sed -i '/^WARN.*/d' tongcheng_rec_token_d.txt 
mysql -hrm-2ze6406t9hkur76rk.mysql.rds.aliyuncs.com -P3306 -uinke_db_user -p'Nx$X6^soiPi' -e "LOAD DATA LOCAL INFILE '/home/huanghongyu/tongcheng_rec_token_d.txt' INTO TABLE db_inke_pm_strategy.tongcheng_rec_token CHARACTER SET utf8 fields terminated by '\t' lines terminated by '\n';"  
